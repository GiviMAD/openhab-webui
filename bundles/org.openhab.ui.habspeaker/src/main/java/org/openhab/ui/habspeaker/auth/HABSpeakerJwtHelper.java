 ...
 */
package org.openhab.ui.habspeaker.auth;
...
/**
 * An implementation of {@link HABSpeakerJwtHelper} which will validate jwt tokens.
 *
 * @author Miguel Álvarez - Initial contribution
 */
@NonNullByDefault
public class HABSpeakerJwtHelper {
    private final Logger logger = LoggerFactory.getLogger(HABSpeakerJwtHelper.class);
