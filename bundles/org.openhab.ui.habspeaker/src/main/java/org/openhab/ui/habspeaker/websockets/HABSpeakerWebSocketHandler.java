 ...
 */
package org.openhab.ui.habspeaker.websockets;

import static org.openhab.ui.habspeaker.websockets.HABSpeakerWebSocketServlet.ALT_AUTH_HEADER;
import static org.openhab.ui.habspeaker.websockets.HABSpeakerWebSocketServlet.NAME;
...
import org.openhab.ui.habspeaker.audio.HABSpeakerAudioSink;
import org.openhab.ui.habspeaker.audio.HABSpeakerAudioSource;
...
public class HABSpeakerWebSocketHandler extends WebSocketAdapter {
    ...
    private void startDialog() {
        ...
        try {
            servlet.voiceManager.listenAndAnswer(null, null, null, List.of(), source, sink, null, listeningItem);
