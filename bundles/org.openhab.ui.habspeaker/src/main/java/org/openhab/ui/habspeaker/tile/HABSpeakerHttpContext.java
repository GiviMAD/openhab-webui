 ...
 */
@NonNullByDefault
public class HABSpeakerHttpContext implements HttpContext {
    private final Logger logger = LoggerFactory.getLogger(HABSpeakerHttpContext.class);
    ...
    /**
     * Constructs an {@link HABSpeakerHttpContext} with will another {@link HttpContext} as a base.
     *
     * @param defaultHttpContext the base {@link HttpContext} - use {@link HttpService#createDefaultHttpContext()} to
     *            create a default one
     */
    public HABSpeakerHttpContext(HttpContext defaultHttpContext, String resourcesBase, boolean useGzipCompression) {
